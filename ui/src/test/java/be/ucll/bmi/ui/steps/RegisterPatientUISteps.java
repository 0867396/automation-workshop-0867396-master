...
public class RegisterPatientUISteps extends UISteps {
    ...
    public void martha_has_chosen_to_add_sara_as_a_patient() {
       ...
       String sara = Persona.getSsn("Sara");
       patientDetailsPage.open(sara);
    }
    @When("Martha provides Sara's personal details:")
    public void martha_provides_sara_s_personal_details(io.cucumber.datatable.DataTable dataTable) throws InterruptedException {
        // Write code here that turns the phrase above into concrete actions
    ...
    public void martha_provides_sara_s_first_examination_details(io.cucumber.datatable.DataTable dataTable) throws InterruptedException{
        // Write code here that turns the phrase above into concrete actions
        // For automatic transformation, change DataTable to one of
        // E, List<E>, List<List<E>>, List<Map<K,V>>, Map<K,V> or
        // Map<K, List<V>>. E,K,V must be a String, Integer, Float,
